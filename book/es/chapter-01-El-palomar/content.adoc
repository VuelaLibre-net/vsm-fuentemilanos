...
Inicialmente es conveniente hacer los vuelos con el tren de aterrizaje fuera, porque será un elemento menos a tener en cuenta en las maniobras de aproximación, pero una vez nos vayamos encontrando más seguros, es importante practicar la extensión y retracción del tren y siempre añadiendo el `rueda fuera` a continuación de la comunicación del `viento en cola`. Esta es una regla mnemotécnica importante que nos salvará de más de un aterrizaje con el tren dentro.

== Alas de plomo

.Alas de plomo
image::cap-01-fig-02-alas-de-plomo.png[pdfwidth=75%]
...
También debemos familiarizarnos con los lugares que, casi invariablemente, producen ascendencias. En nuestro caso, hay lugares muy cercanos al aeródromo, que frecuentemente ofrecen térmicas "de servicio", como son los pueblos de Abades y Fuentemilanos, la granja de cerdos al SW, y la vaguada al _W_ de la pista.
...
Pensemos que la entrada en pérdida a baja altura ha sido la causa principal de la mayoría de los accidentes fatales en el VsM.
...
Nos ceñiremos estrictamente a las normas del aeródromo para el tráfico, especialmente la zona asignada al VsM, las comunicaciones y las alturas.
...
El "centrado" de la térmica es la técnica fundamental del VsM y sólo se puede adquirir y mejorar con la práctica constante y procurando volar en todo tipo de condiciones, no sólo en los días buenos.
...
[sidebar]
En mi primer vuelo con un instructor de alto nivel y un velero también de alto nivel, la primera sorpresa fue que la técnica de centrado que usaba el instructor, era pura y simplemente la misma que la que yo usaba, aun siendo un novato: Enderezar levemente hacia donde "intuía" que estaba el centro de la térmica. Pero el problema no es la técnica en sí, sino la "intuición". No es lo mismo la "intuición" de un novato que la de un piloto con miles de horas de VsM.
...
Los días con viento de _N_ moderado y al atardecer cuando el sol calienta la ladera, volar sobre ella es un auténtica delicia. Incluso he tenido el privilegio de volar junto a un grupo de seis ó siete majestuosos buitres que frecuentan la zona.
****
...
[sidebar]
****
Estoy virando un térmica sobre Segovia y el vario me indica 4m/s., alcanzo la base del cúmulo a unos 2.000 mts., me siento exultante y feliz, hasta que miro al _E_ y veo la sierra alejarse hasta La Salceda.
